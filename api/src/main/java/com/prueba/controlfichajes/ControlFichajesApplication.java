...
public class ControlFichajesApplication {
    private static final Logger LOG = LoggerFactory.getLogger(ControlFichajesApplication.class);
    ...
    public static void main(String[] args) {
        ...
        createAlarmConfigurationMaxWorkingHours(alarmRepository);
        createAlarmConfigurationMinEntryTime(alarmRepository);
    }

    private static void createAlarmConfigurationMaxWorkingHours(AlarmRepository alarmRepository) {
        LOG.info("Initializing Max Working Hours Alarm");
    ...
    private static void createAlarmConfigurationMinEntryTime(AlarmRepository alarmRepository) {
        LOG.info("Initializing Min Entry Time Alarm");
        AlarmConfiguration configuration = new AlarmConfiguration();
        configuration.setBusinessId("1");
